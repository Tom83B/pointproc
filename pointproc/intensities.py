...
class IntensityFunction:
    def __init__(self, func, integral, init_params, bounds):
        self._func = func
    ...
    def __add__(self, other):
        ...
        return IntensityFunction(new_func, new_integral, new_init_params, new_bounds)


class ConstantIntensity(IntensityFunction):
    def __init__(self, init=1, bounds=(0, None)):
        def func(t, intensity): return np.ones_like(t) * intensity
        def integral(t, intensity): return t * intensity
        
        super(ConstantIntensity, self).__init__(func, integral, [init], [bounds])
...
class ExponentialDecay(IntensityFunction):
    def __init__(self, init=None, bounds=None):
        ...
        super(ExponentialDecay, self).__init__(func, integral, init, bounds)
